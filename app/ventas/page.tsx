...
export const metadata = {
  title: "Ventas - Inmobiliaria Premium",
  description: "Las mejores propiedades en venta. Casas, departamentos, terrenos y más.",
}
        ...
        <section className="bg-primary py-20">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-primary-foreground/80 mt-4 max-w-2xl mx-auto leading-relaxed">
              Invierte en tu futuro. Descubre nuestra selección exclusiva de propiedades en venta.
            </p>
          </div>
        </section>
